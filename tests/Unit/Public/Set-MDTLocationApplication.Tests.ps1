...
InModuleScope $ProjectName {
    ...
    Describe Set-MDTLocationApplication {
        ...
        It 'Should not throw under any circumstances' {
            { Set-MDTLocationApplication -Id $mocks.Id -Applications $mocks.Applications -Force } | Should -Not -Throw
        }

        It 'Should output something to the console' {
            Mock -CommandName Write-Output

            Set-MDTLocationApplication -Id $mocks.Id -Applications $mocks.Applications -Force
