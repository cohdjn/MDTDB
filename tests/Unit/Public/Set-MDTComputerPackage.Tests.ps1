...
InModuleScope $ProjectName {
    ...
    Describe Set-MDTComputerPackage {
        ...
        It 'Should not throw under any circumstances' {
            { Set-MDTComputerPackage -Id $mocks.Id -Packages $mocks.Packages -Force } | Should -Not -Throw
        }

        It 'Should output something to the console' {
            Mock -CommandName Write-Output

            Set-MDTComputerPackage -Id $mocks.Id -Packages $mocks.Packages -Force
