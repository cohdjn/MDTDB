...
InModuleScope $ProjectName {
    ...
    Describe Set-MDTMakeModelApplication {
        ...
        It 'Should not throw under any circumstances' {
            { Set-MDTMakeModelApplication -Id $mocks.Id -Applications $mocks.Applications -Force } | Should -Not -Throw
        }

        It 'Should output something to the console' {
            Mock -CommandName Write-Output

            Set-MDTMakeModelApplication -Id $mocks.Id -Applications $mocks.Applications -Force
