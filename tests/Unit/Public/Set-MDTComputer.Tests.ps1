    ...
    Describe Set-MDTComputer {
        ...
        Context 'When called with appropriate arguments defined' {
            ...
            It 'Should not throw under any circumstances' {
                { Set-MDTComputer -Id $goodMocks.Id -Settings $goodMocks.Settings -Force } | Should -Not -Throw
            }
            ...
            It 'Should return valid data' {
                ...
                $updateComputer = Set-MDTComputer -Id $goodMocks.Id -Settings $goodMocks.Settings -Force
                ($updateComputer | Measure-Object).Count | Should -Be 1
            }
            
            It 'Should output something to the console' {
                Mock -CommandName Write-Output

                Set-MDTComputer -Id $goodMocks.Id -Settings $goodMocks.Settings -Force
