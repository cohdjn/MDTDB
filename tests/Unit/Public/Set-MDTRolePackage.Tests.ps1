...
InModuleScope $ProjectName {
    ...
    Describe Set-MDTRolePackage {
        ...
        It 'Should not throw under any circumstances' {
            { Set-MDTRolePackage -Id $mocks.Id -Packages $mocks.Packages -Force } | Should -Not -Throw
        }

        It 'Should output something to the console' {
            Mock -CommandName Write-Output

            Set-MDTRolePackage -Id $mocks.Id -Packages $mocks.Packages -Force
