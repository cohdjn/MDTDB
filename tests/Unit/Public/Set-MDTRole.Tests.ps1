    ...
    Describe Set-MDTRole {
        ...
        Context 'When called with appropriate arguments defined' {
            ...
            It 'Should not throw under any circumstances' {
                { Set-MDTRole -Id $goodMocks.Id -Settings $goodMocks.Settings -Force } | Should -Not -Throw
            }
            ...
            It 'Should return valid data' {
                ...
                $updateRole = Set-MDTRole -Id $goodMocks.Id -Settings $goodMocks.Settings -Force
                ($updateRole | Measure-Object).Count | Should -Be 1
            }
            
            It 'Should output something to the console' {
                Mock -CommandName Write-Output

                Set-MDTRole -Id $goodMocks.Id -Settings $goodMocks.Settings -Force
