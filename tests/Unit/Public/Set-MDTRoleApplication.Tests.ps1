...
InModuleScope $ProjectName {
    ...
    Describe Set-MDTRoleApplication {
        ...
        It 'Should not throw under any circumstances' {
            { Set-MDTRoleApplication -Id $mocks.Id -Applications $mocks.Applications -Force } | Should -Not -Throw
        }

        It 'Should output something to the console' {
            Mock -CommandName Write-Output

            Set-MDTRoleApplication -Id $mocks.Id -Applications $mocks.Applications -Force
