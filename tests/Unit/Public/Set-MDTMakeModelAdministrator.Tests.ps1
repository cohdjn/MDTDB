...
InModuleScope $ProjectName {
    ...
    Describe Set-MDTMakeModelAdministrator {
        ...
        It 'Should not throw under any circumstances' {
            { Set-MDTMakeModelAdministrator -Id $mocks.Id -Administrators $mocks.Administrators -Force } | Should -Not -Throw
        }

        It 'Should output something to the console' {
            Mock -CommandName Write-Output

            Set-MDTMakeModelAdministrator -Id $mocks.Id -Administrators $mocks.Administrators -Force
