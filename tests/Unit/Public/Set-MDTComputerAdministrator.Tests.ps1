...
InModuleScope $ProjectName {
    ...
    Describe Set-MDTComputerAdministrator {
        ...
        It 'Should not throw under any circumstances' {
            { Set-MDTComputerAdministrator -Id $mocks.Id -Administrators $mocks.Administrators -Force } | Should -Not -Throw
        }

        It 'Should output something to the console' {
            Mock -CommandName Write-Output

            Set-MDTComputerAdministrator -Id $mocks.Id -Administrators $mocks.Administrators -Force
