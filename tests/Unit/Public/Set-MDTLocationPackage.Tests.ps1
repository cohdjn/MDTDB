...
InModuleScope $ProjectName {
    ...
    Describe Set-MDTLocationPackage {
        ...
        It 'Should not throw under any circumstances' {
            { Set-MDTLocationPackage -Id $mocks.Id -Packages $mocks.Packages -Force } | Should -Not -Throw
        }

        It 'Should output something to the console' {
            Mock -CommandName Write-Output

            Set-MDTLocationPackage -Id $mocks.Id -Packages $mocks.Packages -Force
